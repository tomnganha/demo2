...
<html>
  <head>
    ...
    <style>
      ...
      .gasColor {color: #15a415;}  /* Adjust color as needed for gas readings */
      .fanColor {color: #00878F;}  /* Adjust color as needed for fan readings */
  ...
  <body>
    ...
    <div class="content">
      <div class="cards">
        ...
        <div class="card">
          ...
          <!-- Displays the gas value received from ESP32. *** -->
          <h4 class="gasColor"><i class="fas fa-gas-pump"></i> GAS VALUE</h4>
          <p class="gasColor"><span class="reading"><span id="gas_valua"></span> ppm</span></p>
          <!-- *********************************************************************** -->
          
          <p class="statusreadColor"><span>Status Read Sensor MQ2 : </span><span id="ESP32_01_Status_Read_DHT11"></span></p>
        </div>
        <!-- ======================================================================================================= -->
        ...
        <div class="card">
          ...
          <!-- Buttons for controlling the LEDs and Fan on Slave 2. ************************** -->
          ...
          <h4 class="fanColor"><i class="fas fa-fan"></i> Quat</h4>
          <label class="switch">
            <input type="checkbox" id="ESP32_01_TogFan" onclick="GetTogBtnLEDState('ESP32_01_TogFan')">
            <div class="sliderTS"></div>
          </label>
          <!-- *********************************************************************** -->
        </div>  
    ...
    <script>
      var gas_value = "NN";  // Declare the gas_value variable
      ...
      document.getElementById("gas_valua").innerHTML = "NN";  // Initialize gas_value
      //------------------------------------------------------------
          ...
          xmlhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
              ...
              if (myObj.id == "esp32_01") {
                ...
                document.getElementById("gas_valua").innerHTML = myObj.gas_value; // Update gas_value
                gas_value = myObj.gas_value; // Update the gas_value variable
                // ... existing code ...
              }
            }
          };
